...
const { idExistOrganismo, nombreExistOrganismo, codigoExistOrganismo} = require('./database');
...
const validationSchema =  {
    codigo: {
        ...
        custom: {options: codigoExistOrganismo },
    },
    nombre: {
        isEmpty: {
        ...
        custom: {options: nombreExistOrganismo },
    }
    /*activo: {
        isBoolean: {
...
const getValidateUpdate= [
    checkSchema({
        id: {
            in: ["params"],
            custom: { options: idExistOrganismo},
        },
        ...validationSchema
    }),
    validatedResponse
...
const validateDelete = [
    checkSchema({
        id: { in: ["params"], custom: { options: idExistOrganismo} },
        activo: {
            isInt: {
